...
TIPOS DE DATOS : 
	PRIMITIVOS: 
		...
		ES DE TIPADO ESTÁTICO.  ES DECIR, SE DEFINE EL TIPO DE DATO A LA HORA DE DEFINIR LA VARIABLE.
		
		ENTEROS - FLOTANTES - CARACTERES - BOLEANOS  ------> TODOS LOS TIPOS DE DATOS SE ESCRIBEN EN MINÚSCULA.
		...
		CARACTERES ------------------
			char : USA CÓDIGO UNICODE Y CADA CARACTER USA 16 BITS.
			
			UN CHAR PUEDE TENER UN SOLO CARACTER, EJ: 
			char a = 'a';
			
			TAMBIÉN UN CHAR PUEDE TENER MÁS DE UN CARACTER SIEMPRE Y CUANDO SEA UN CODIGO UNICODE 
			char c = '\u0021'
