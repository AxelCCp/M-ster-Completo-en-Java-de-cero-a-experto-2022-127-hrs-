...
public class B7_31_StringMetodos {
	...
	public static void main(String[]args) {
		...
		System.out.println("nombre.compareTo(\"\") = " + nombre.compareTo("andres"));  							//ESTE MÉTODO DA 0 SI SON IGUALES. LOS COMPARA LEXICO GRAFICAMENTE SEGÚN LOS VALORES UNICODE.
		System.out.println("nombre.charAt() = " + nombre.charAt(0));											//CONVERTIR UN STRING EN CARACTERES U OBTENER UN CARACTER EN PARTICULAR
		System.out.println("nombre.charAt() = " + nombre.charAt(nombre.length() - 1));                          //PARA OBTENER LA ÚLTIMA LETRA	
		System.out.println("nombre.subString() = " + nombre.substring(3));										//TOMA DESDE EL ÍNDICE INDICADO HACIA ADELANTE.
		System.out.println("nombre.subString() = " + nombre.substring(2,5));                                    //2 LO INCLUYE , 5 NO LO INCLUYE
		System.out.println("nombre.subString() = " + nombre.substring(nombre.length() - 1));                    //OBTIENE LA ÚLTIMA LETRA.	 
