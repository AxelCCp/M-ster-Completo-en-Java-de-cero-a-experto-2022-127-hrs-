...
public class A1_36_OperadoresAritmeticos {
	...
	public static void main(String[]args) {
		...
		System.out.println("i+j = " + (i+j));  // R : PRIMERO REALIZA LA SUMA EN LOS () Y DESPUÉS CONCATENA ... i+j = 12
	  ...
	  //System.out.println("i-j = " + i-j);    // R : ESTO DA UN ERROR
		...
		System.out.println("división = " + div);	// R : 0 ... POR SER VALORES DEL TIPO INT.
		
		float div2 = i/j;
		
		System.out.println("división = " + div2);   // R : 0.0 ... FALTA HACWRLE CAST AL I Y/O J
		
		div2 = (float)i/(float)j;
		
		System.out.println("división = " + div2);	// R : 0.71428573 ... OK
