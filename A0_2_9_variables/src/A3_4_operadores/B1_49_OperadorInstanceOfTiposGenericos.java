...
public class B1_49_OperadorInstanceOfTiposGenericos {
	...
	public static void main(String[] args) {
		...
		//MANERA MÁS CORRECTA PARA INSTANCIAR CON LA CLASE NUMBER UN NUMERO QUE SEA DE UN TIPO COMO INTEGER 
		...
		//ESTO SI PERMITE VALIDARLO SIN QUE DÉ ERROR DE COMPILACIÓN
